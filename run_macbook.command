...
echo "   - Model: SDXL Turbo (fast) or SD 1.5 (lightweight)"
echo "   - Recommended Workflow: shreenay_workflow_macbook_air.json"
echo "   - Memory Flags: --lowvram --disable-smart-memory"
echo ""
echo "📝 Available workflows:"
echo "   - shreenay_workflow_macbook_air.json (recommended - SDXL Turbo)"
echo "   - shreenay_workflow_sd15.json (SD 1.5 - most memory efficient)"
