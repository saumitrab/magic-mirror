...
echo "   - Model: Flux Schnell Q4 + IP-Adapter"
echo "   - Recommended Workflow: shreenay_workflow_macmini_ipadapter.json"
echo ""
echo "📝 Available workflows:"
echo "   - shreenay_workflow_macmini_ipadapter.json ⭐ (BEST - Flux + Face Preservation)"
echo "   - shreenay_workflow_macmini.json (basic - Flux only)"
echo "   - shreenay_workflow_flux_schnell.json (alternative)"
echo ""
